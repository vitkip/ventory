...
export default function Edit({ auth, customer }: EditProps) {
  ...
  const breadcrumbsItems = [
    ...
    { title: 'ແກ້ໄຂຂໍ້ມູນ', url: undefined }
  ]
      ...
      header={
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-sm text-gray-500 dark:text-gray-400">ແກ້ໄຂຂໍ້ມູນ</div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{customer.name}</h2>
          </div>
        </div>
      }
    >
      <Head title={`ແກ້ໄຂຂໍ້ມູນລູກຄ້າ - ${customer.name}`} />
              ...
              <div className="lg:col-span-1">
                <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">ຮູບພາບ</h3>
                  </div>
                  <div className="p-6">
                    <img 
                    ...
                    <div className="text-sm italic text-gray-500 dark:text-gray-400 mb-4">
                      ໄຟລ໌ JPG ຫຼື PNG ຂະໜາດບໍ່ເກີນ 2 MB
                    </div>
