...
export default function Show({ auth, quotation }: ShowProps) {
  ...
  const getStatusText = (status: number) => {
    switch (status) {
      case 0: return 'ຮ່າງ'
      case 1: return 'ສົ່ງແລ້ວ'
      case 2: return 'ຂາຍແລ້ວ'
      case 3: return 'ຍົກເລີກ'
  ...
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">ໃບສະເໜີລາຄາ #{quotation.reference}</h2>
              </div>
    ...
    >
      <Head title={`ໃບສະເໜີລາຄາ #${quotation.reference}`} />
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">ລາຍລະອຽດໃບສະເໜີລາຄາ</h3>
              <div>
            ...
            <div className="px-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ຂໍ້ມູນລູກຄ້າ</h4>
                  <div className="text-gray-700 dark:text-gray-300">
                    <p className="font-bold">{quotation.customer.name}</p>
                    <p>ອີເມລ: {quotation.customer.email}</p>
                    <p>ໂທ: {quotation.customer.phone}</p>
                    <p>ທີ່ຢູ່: {quotation.customer.address}</p>
                  </div>
                </div>
                <div className="md:text-right">
                  <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ລາຍລະອຽດໃບສະເໜີລາຄາ</h4>
                  <div className="text-gray-700 dark:text-gray-300">
                    <p><span className="font-medium">ເລກທີອ້າງອິງ:</span> {quotation.reference}</p>
                    <p><span className="font-medium">ວັນທີ:</span> {formatDate(quotation.date)}</p>
                    <p><span className="font-medium">ວັນທີໝົດອາຍຸ:</span> {formatDate(quotation.due_date)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead>
                    <tr>
                      <th className="px-3 py-3 bg-gray-50 dark:bg-gray-700 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-12">ລຳດັບ</th>
                      <th className="px-3 py-3 bg-gray-50 dark:bg-gray-700 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">ສິນຄ້າ</th>
                      <th className="px-3 py-3 bg-gray-50 dark:bg-gray-700 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-24">ລາຄາຕໍ່ໜ່ວຍ</th>
                      <th className="px-3 py-3 bg-gray-50 dark:bg-gray-700 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-24">ຈຳນວນ</th>
                      <th className="px-3 py-3 bg-gray-50 dark:bg-gray-700 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-32">ຍອດລວມ</th>
                    </tr>
                  </thead>
                  ...
                  <tfoot className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      <td colSpan={4} className="px-3 py-3 text-sm text-gray-700 dark:text-gray-300 text-right font-medium">ຍອດລວມ:</td>
                    ...
                    {quotation.discount_amount > 0 && (
                      <tr>
                        <td colSpan={4} className="px-3 py-3 text-sm text-gray-700 dark:text-gray-300 text-right font-medium">ສ່ວນຫຼຸດ:</td>
                    ...
                    <tr>
                      <td colSpan={4} className="px-3 py-3 text-sm text-gray-700 dark:text-gray-300 text-right font-medium">ພາສີມູນຄ່າເພີມ (7%):</td>
                    ...
                    <tr>
                      <td colSpan={4} className="px-3 py-3 text-sm text-gray-900 dark:text-gray-100 text-right font-bold">ຍອດລວມສຸດທິ:</td>
              ...
              {quotation.notes && (
                <div className="mt-6">
                  <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ໝາຍເຫດ</h4>
              ...
              {quotation.terms && (
                <div className="mt-6">
                  <h4 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ເງື່ອນໄຂແລະຂໍ້ຕົກລົງ</h4>
