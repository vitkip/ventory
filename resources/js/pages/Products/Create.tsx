...
export default function Create({ auth, categories, units }: CreateProps) {
  ...
  const breadcrumbsItems = [
    ...
    { title: 'ເພີ່ມສິນຄ້າໃໝ່', url: undefined }
  ]
      ...
      header={
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">ເພີ່ມສິນຄ້າໃໝ່</h2>
          </div>
        </div>
      }
    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="flex rounded-md shadow-sm">
                            ...
                            <div className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-r-md">
                              <label className="flex items-center space-x-2 cursor-pointer">
                                ...
                                />
                                <span className="text-sm">ສ້າງອັດຕະໂນມັດ</span>
                              </label>
                            </div>
                          </div>
                          {errors.slug && (
                      ...
                      <div>
                        <div className="mb-4">
                          <label htmlFor="selling_price" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            ລາຄາຂາຍ (ບາດ) <span className="text-red-600">*</span>
                          </label>
                          <input
                            id="selling_price"
                            type="number"
                      ...
                      <div>
                        <div className="mb-4">
                          ...
                          >
                            <option value="0">ລວມໃນລາຄາສິນຄ້າ</option>
