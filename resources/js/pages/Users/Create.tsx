...
export default function Create({ auth }: CreateProps) {
  ...
  const breadcrumbsItems = [
    ...
    { title: 'ຜູ້ໃຊ້', url: route('users.index') },
    { title: 'ເພີ່ມຜູ້ໃຊ້ໃໝ່', url: undefined }
  ]
      ...
      header={
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">ເພີ່ມຜູ້ໃຊ້ໃໝ່</h2>
          </div>
        </div>
      }
    >
      <Head title="ເພີ່ມຜູ້ໃຊ້ໃໝ່" />
                      ...
                      <div className="md:col-span-2">
                        <div className="mb-4">
                          <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            ເມລ <span className="text-red-600">*</span>
                          </label>
                          <input
                            id="email"
                            type="email"
                      ...
                      <div>
                        <div className="mb-4">
                          <label htmlFor="password_confirmation" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            ຍືນຍັນລະຫັດຜ່ານ <span className="text-red-600">*</span>
                          </label>
                          <input
